...
docker run -d --name productpage --link details:details --link reviews:reviews -p 8083:8083 --link ratings:ratings -e "DETAILS_HOSTNAME=http://details:8081" -e "REVIEWS_HOSTNAME=http://reviews:8082" -e "RATINGS_HOSTNAME=http://ratings:8080" productpage